...
public class HidDeviceApp
        implements MouseReport.MouseDataSender, KeyboardReport.KeyboardDataSender, BatteryReport.BatteryDataSender {

    private static final String TAG = HidDeviceApp.class.getSimpleName();
    ...
    void registerApp(BluetoothProfile inputHost) {
        ...
        this.inputHost.registerApp(Constants.SDP_RECORD, null, Constants.QOS_OUT, Runnable::run, callback);
    }
