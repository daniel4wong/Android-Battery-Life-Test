...
import com.daniel4wong.core.Bluetooth.Hid.KeyboardReport;
...
public class HidKeyboardHelper {
    ...
    private final KeyboardReport.KeyboardDataSender dataSender;

    /** @param dataSender Interface to send the Keyboard data with. */
    public HidKeyboardHelper(KeyboardReport.KeyboardDataSender dataSender) {
    ...
    public void send(Object key) {
        if (key instanceof Integer) {
            sendKeyDown(Modifier.NONE, (int) key);
            sendKeysUp(Modifier.NONE);
