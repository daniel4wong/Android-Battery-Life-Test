...
public class BatteryTestManager extends Singleton implements ISingleton {
    ...
    public void start(Integer testFrequency) {
        ...
        if (!isRunning) {
            runnable = () -> {
                ...
                Toast.makeText(getContext(), getContext().getString(R.string.msg_test_start), Toast.LENGTH_LONG).show();
    ...
    public void stop() {
        reset();
        isRunning = false;
        Toast.makeText(getContext(), getContext().getString(R.string.msg_test_stop), Toast.LENGTH_LONG).show();
    }
